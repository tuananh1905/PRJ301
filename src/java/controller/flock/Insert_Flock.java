...
public class Insert_Flock extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("../view/flock/insertTest.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String raw_purchase_date = request.getParameter("purchase");
        String raw_sale_date = request.getParameter("sale");
